...
const Auth = ({handleSuccessLogin}) => {
  ...
  const buttonClass = loginStatus === 'shopper' ? 'insta-mart-button shopper-btn':'insta-mart-button seller-btn'
  ...
  return (
    <div className='auth-page' style={{backgroundColor:loginStatus === 'shopper' ? '#E2F2FF':'#1564C1'}}>
        ...
        <div className='right-section'>
            <button style={{color:loginStatus === 'shopper' ? '#1564C1':'#E2F2FF'}} className='guest-login-btn' onClick={onGuestLogin}>GUEST LOGIN <BsArrowRight style={{fontSize:"24px"}}/></button>
